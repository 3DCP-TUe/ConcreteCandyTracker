...
%   percentiles. The results are returned as a table suitable for analysis.
%
%   Inputs:
%       times      - Vector of step-up times corresponding to each response
%       responses  - Cell array of step-up response tables, each table must
...
%
%   Notes:
%       - The step-up response values should be normalized (0-1 scale).
%       - Percentiles are calculated based on the time when the normalized
%         response reaches the corresponding fraction of the step-up.
